...
**Training**: [POINTCOSM](https://www.pointcosm.cn/) for Gaussian Splatting reconstruction  

**Viewer**: Converted to an embedded viewer with [supersplat](https://github.com/playcanvas/supersplat)